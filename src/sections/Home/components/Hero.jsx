  ...
  return (
    ...
    >
      ...
      <motion.div style={{ y, opacity }} className="absolute inset-0">
        <div className="absolute top-0 right-0 w-[500px] h-[500px] bg-purple-500/20 rounded-full blur-[120px] animate-pulse" />
        <div className="absolute bottom-0 left-0 w-[500px] h-[500px] bg-teal-500/20 rounded-full blur-[120px] animate-pulse delay-1000" />
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] bg-pink-500/10 rounded-full blur-[120px] animate-pulse delay-500" />
      </motion.div>
            ...
            >
              {[
                ...
                <div key={index} className="space-y-1">
                  <div className="text-3xl sm:text-4xl font-bold bg-gradient-to-r from-purple-400 to-teal-400 bg-clip-text text-transparent">
                    {stat.value}
                  </div>
          ...
          >
            ...
            <div className="relative">
              ...
              <motion.div
                ...
                className="relative w-full aspect-square rounded-3xl bg-gradient-to-br from-purple-500/20 to-teal-500/20 backdrop-blur-xl border border-purple-500/20 overflow-hidden"
              >
                {/* Inner glow */}
                <div className="absolute inset-0 bg-gradient-to-tr from-purple-500/10 via-transparent to-teal-500/10" />
